        ...
        <div class="container">
            <div class="row">
                ...
                <div class="d-flex flex-column justify-content-center ml-lg-auto mr-lg-5 col-lg-5 col-md-6 col-12">
                    ...
                    <h6 class="mb-4 text-white" data-aos="fade-up">Your membership is up to 2 months FREE ($62.50 per
                        month)</h6>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="membership-form webform" role="form" action="registration.php" method="POST">
                        ...
                        <button type="submit" class="form-control" id="submit-button" name="data-register">Đăng
                            ký</button>
