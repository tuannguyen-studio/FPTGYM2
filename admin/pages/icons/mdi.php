                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      echo "<tbody>
                        ...
                        ."</td>
                        <td>";
                        echo "<a type='button' class='btn btn-outline-success btn-fw' href='xacnhan.php?id=$id&type=$GoiTap&time=$time' ><i class='fas fa-check'></i></a> <a type='button' class='btn btn-outline-danger btn-fw' href='xoaDK.php?id=$id' ><i class='fas fa-times'></i></a>"
                        ."</td>
                        </tr>";
                            }
                          }
